...
```mermaid
flowchart LR
    M1["Module 1<br/>Setup, IAM, Billing<br/>& AI Studio Dashboard"] --> M2["Module 2<br/>Prompts, System Instructions,<br/>Imagen 3, Veo & LLMs"]
...
| **02** | [**Basics, Prompts, System Instructions, Media Generation & LLMs**](./en/module-02-basics-prompts-media-llms/README.md)<br/>[**Fundamentos, Prompts, Instrucciones del Sistema, Multimedia y LLMs**](./es/module-02-basics-prompts-media-llms/README.md) | Model selection (`gemini-2.5-flash` vs. `gemini-2.5-pro`), Thinking Budgets (`thinking_config`), System Instructions, deterministic JSON outputs (Pydantic / JSON Schema), image generation with **Imagen 3**, video generation with **Veo**, and **Stage 1 of the Flagship Project**. | [`labs/module-02-prompts-media/`](./labs/module-02-prompts-media/)<br/>[`notebooks/02_Prompts_Structured_Outputs_Imagen3_and_Veo.ipynb`](./notebooks/02_Prompts_Structured_Outputs_Imagen3_and_Veo.ipynb) |
...
| **02. Prompts, Structured Outputs, Imagen 3 & Veo** | Build Stage 1 of the AI Product Studio with System Instructions, Thinking Budgets, Pydantic schemas, Imagen 3 & Veo. | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/AllInVaders/aistudio-full-course/blob/main/notebooks/02_Prompts_Structured_Outputs_Imagen3_and_Veo.ipynb) |
