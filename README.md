...
[![Google Slides Deck](https://img.shields.io/badge/Google_Slides-20--Slide_Playbook-ea4335?style=for-the-badge)](https://docs.google.com/presentation/d/1mYxjBzqB56KKXE7WrFRqiRQJo3K9mvRZ9iKYGdgGJ3M/edit)
[![Google Slides Deck](https://img.shields.io/badge/Google_Slides-20--Slide_Playbook-ea4335?style=for-the-badge)](https://docs.google.com/presentation/d/1TCHyTk7QURiG9dGdL1xmwTpds7gUIads_HmlIKCB2ug/edit)
...
| **Google Slides Visual Playbook** | 20-slide native editable Google Slides deck with API Key setup, GitHub links & bilingual copy-paste prompts | [**Open Google Slides ↗**](https://docs.google.com/presentation/d/1mYxjBzqB56KKXE7WrFRqiRQJo3K9mvRZ9iKYGdgGJ3M/edit) · [**Playbook (`slides/`) →**](./slides/README.md) |
| **Google Slides Visual Playbook** | 20-slide native editable Google Slides deck with API Key setup, GitHub links & bilingual copy-paste prompts | [**Open Google Slides ↗**](https://docs.google.com/presentation/d/1TCHyTk7QURiG9dGdL1xmwTpds7gUIads_HmlIKCB2ug/edit) · [**Playbook (`slides/`) →**](./slides/README.md) |
...
> and `gemini-3.8-live` is superseded by `gemini-3.8-live`. See the
